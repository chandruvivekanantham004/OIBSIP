...
public class OnlineExamSystem {
    ...
    public OnlineExamSystem(String username, String password) {
        ...
        System.out.println(" You're sucessfully  registered :)");
        this.isLoggedIn = false;
        this.timeRemaining = 3; // time remaining in minutes
        this.questionCount = 4;
        this.userAnswers = new int[questionCount];
        this.correctAnswers = new int[questionCount];
        // initialize correct answers with random values either it would be(0 or 1)
    ...
    public void startExam() {
        ...
        if (n == 1) {
            ...
            // it will auto submit when the time is over
            try {
                Thread.sleep(timeRemaining * 3 * 1000);
